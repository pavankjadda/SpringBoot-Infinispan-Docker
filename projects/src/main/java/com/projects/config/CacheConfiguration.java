...
public class CacheConfiguration {
        ...
        log.info("Defining Infinispan Global Configuration");
            if(this.registration == null) { // if registry is not defined, use native discovery
                ...
                return () -> GlobalConfigurationBuilder
                    ...
                    .clusterName("infinispan-projects-cluster").globalJmxStatistics()
    ...
    class InfinispanJCacheManager extends JCacheManager {
        ...
        public InfinispanJCacheManager(URI uri, EmbeddedCacheManager cacheManager, CachingProvider provider,
            ...
            registerPredefinedCache(com.projects.domain.Address.class.getName(), new JCache<Object, Object>(
                cacheManager.getCache(com.projects.domain.Address.class.getName()).getAdvancedCache(), this,
                ConfigurationAdapter.create()));
            registerPredefinedCache(com.projects.domain.Employee.class.getName(), new JCache<Object, Object>(
                cacheManager.getCache(com.projects.domain.Employee.class.getName()).getAdvancedCache(), this,
                ConfigurationAdapter.create()));
            registerPredefinedCache(com.projects.domain.Employee.class.getName() + ".employeeProjects", new JCache<Object, Object>(
                cacheManager.getCache(com.projects.domain.Employee.class.getName() + ".employeeProjects").getAdvancedCache(), this,
                ConfigurationAdapter.create()));
            registerPredefinedCache(com.projects.domain.Project.class.getName(), new JCache<Object, Object>(
                cacheManager.getCache(com.projects.domain.Project.class.getName()).getAdvancedCache(), this,
                ConfigurationAdapter.create()));
            registerPredefinedCache(com.projects.domain.Project.class.getName() + ".employeeProjects", new JCache<Object, Object>(
                cacheManager.getCache(com.projects.domain.Project.class.getName() + ".employeeProjects").getAdvancedCache(), this,
                ConfigurationAdapter.create()));
            registerPredefinedCache(com.projects.domain.EmployeeProject.class.getName(), new JCache<Object, Object>(
                cacheManager.getCache(com.projects.domain.EmployeeProject.class.getName()).getAdvancedCache(), this,
                ConfigurationAdapter.create()));
            registerPredefinedCache(com.projects.domain.Department.class.getName(), new JCache<Object, Object>(
                cacheManager.getCache(com.projects.domain.Department.class.getName()).getAdvancedCache(), this,
                ConfigurationAdapter.create()));
