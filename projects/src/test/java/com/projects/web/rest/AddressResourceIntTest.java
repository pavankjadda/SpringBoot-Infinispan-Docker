...
public class AddressResourceIntTest {
    ...
    private static final String DEFAULT_APARTMENT_OR_HOUSE_NUMBER = "AAAAAAAAAA";
    private static final String UPDATED_APARTMENT_OR_HOUSE_NUMBER = "BBBBBBBBBB";
    ...
    public static Address createEntity(EntityManager em) {
        Address address = new Address()
            ...
            .apartmentOrHouseNumber(DEFAULT_APARTMENT_OR_HOUSE_NUMBER)
            .city(DEFAULT_CITY)
    ...
    public void createAddress() throws Exception {
        ...
        assertThat(testAddress.getApartmentOrHouseNumber()).isEqualTo(DEFAULT_APARTMENT_OR_HOUSE_NUMBER);
    ...
    public void getAllAddresses() throws Exception {
        ...
        restAddressMockMvc.perform(get("/api/addresses?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].apartmentOrHouseNumber").value(hasItem(DEFAULT_APARTMENT_OR_HOUSE_NUMBER.toString())))
    ...
    public void getAddress() throws Exception {
        ...
        restAddressMockMvc.perform(get("/api/addresses/{id}", address.getId()))
            ...
            .andExpect(jsonPath("$.apartmentOrHouseNumber").value(DEFAULT_APARTMENT_OR_HOUSE_NUMBER.toString()))
    ...
    public void updateAddress() throws Exception {
        ...
        updatedAddress
            ...
            .apartmentOrHouseNumber(UPDATED_APARTMENT_OR_HOUSE_NUMBER)
            .city(UPDATED_CITY)
        ...
        assertThat(testAddress.getApartmentOrHouseNumber()).isEqualTo(UPDATED_APARTMENT_OR_HOUSE_NUMBER);
